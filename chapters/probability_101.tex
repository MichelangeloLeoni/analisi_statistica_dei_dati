...
An interesting and somewhat unexpected result can be reached when talking about \emph{CDF's}: the \textbf{probability integral transform} (also known as the \emph{universality of the uniform}\sidenote{If you haven't done so already, take a moment to brush up on what a Uniform distribution is, by heading over to the appendix \textcolor{red}{ref}}).
